...
//Movement control
        double drive = -MathUtils.shift(controller.rightStick(), robot.chassis.gyro.angle(true)).y;
        double strafe = MathUtils.shift(controller.rightStick(), robot.chassis.gyro.angle(true)).x;
